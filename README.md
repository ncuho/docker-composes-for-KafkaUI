...
Конфигурационные файлы для запуска тестовых стендов с различными UI для Apache Kafka

Перед запуском необходимо создать каталог для сохранения в него всех конфигов и перейти в него для последующего исполнения команд ниже
